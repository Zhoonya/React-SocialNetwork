...
export const usersAPI = {
    ...
    follow(userId) {
        return (
            instanceAxios.post(`https://social-network.samuraijs.com/api/1.0/follow/${userId}`)
        );
    },

    unfollow(userId) {
        return (
            instanceAxios.delete(`https://social-network.samuraijs.com/api/1.0/follow/${userId}`)
        );
    },
};
